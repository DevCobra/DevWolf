...
install_luarocks() {
  git clone https://github.com/aliwolf/cd-TH3_wolf
  cd luarocks
...
if [ "$1" = "install" ]; then
  ...
  chmod 777 Devwolf.sh
  
  #Adding some color. By @G0vip
   echo -e "\033[38;5;208m"
   echo -e "     > Channel : @hlusat                      "
   echo -e "     > Developer : @g0vip                  "
   echo -e "     > Bot ID : @F4f4f4bot                        "
   echo -e "     > Github : GitHub.com/ii02ii/DevSaqt     "
   echo -e "                                              \033[0;00m"
   echo -e "\e[36m"
  ./tg/bin/telegram-cli -k ./tg/tg-server.pub -s ./bot/Devwolf.lua -l 1 -E $@
fi
